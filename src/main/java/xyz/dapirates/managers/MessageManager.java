...
public class MessageManager {
    ...
    public void sendMessage(Player player, String message, Material material, org.bukkit.Location location, boolean isTNT) {
    ...
    public void broadcastMessage(List<Player> players, String message, Material material, org.bukkit.Location location, boolean isTNT) {
